public class Laptop extends Perangkat {
    ...
    public void informasi(){
        if(webcam == true){
            ...
            System.out.println("Laptop ini tidak diketahui memiliki drive dengan tipe "+drive+" dengan ram sebesar "+ram+"GB, dan processor secepat "+processor+"Ghz. Selain itu laptop ini juga  tidak memiliki Webcam");
        }
       }
